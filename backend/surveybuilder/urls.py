...
urlpatterns = [
    ...
    # post: change q of blocks
    url(r'^questions/block/(?P<id>[0-9]+)$', block_view.update_q),
    ...
    # Create a new URL pattern for the 'Random_assign_questions' view
    # url(r'^surveys/(?P<id>[0-9]+)/(?P<q>[0-9]+)/(?P<flag>[\w-]+)$', survey_view.random_assign_questions),
